...
# <span style="color: red">Draft</span>Link Aggregator Site with Comments - __Due Thursday, March 30th, by 11PM__
...
Instead of creating a separate page for adding items to your list, embed your form directly underneath your link's title and url in the link comments page

The flow of the __comment creation form__ should be:
...
__Add a form to create a new comment to the Link object :__
...
* (if you're using express generator, depending on how you've structured your application this may need to go into a different router file than the one you used for list creation)
...
4. Writing Your Own Session Management (30 points)
